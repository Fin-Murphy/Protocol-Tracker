...
- [ ] Add a more detailed walkthrough
- [ ] ADD STUDY POINTS
...
- [ ] Reorg the indexing for items so that they save to DayData items instead of a unified list
	> Deferred for now - Not super necessary. Might make it a little more SOLID but whatev
